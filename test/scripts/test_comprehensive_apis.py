...
def create_test_pdf():
    ...
    try:
        ...
        c.drawString(100, 710, "The AI should be able to answer questions about this content.")
        c.drawString(100, 690, "Test question: What is this document about?")
        c.drawString(100, 670, "Answer: This is a test document for the Mimir API system.")
        c.save()
        pdf_buffer.seek(0)
        return pdf_buffer
    except ImportError:
...
def load_test_image():
    ...
    if os.path.exists(test_image_path):
        print(f"   📸 Using facial recognition test image: {os.path.basename(test_image_path)}")
    ...
    if auth_token:
        try:
            ...
            if test_pdf:
                ...
                response = session.post(f"{base_url}/user/upload", 
